...
var makeUrl=require("./util/makeurl"),PATH_TOKEN="oauth/token",PATH_AUTHORIZE="oauth/authorize",KEY_PRIVATE_TOKEN="emPrivateToken",KEY_REFRESH_TOKEN="emRefreshToken",KEY_ACCESS_TOKEN="emAccessToken";module.exports=function(e,t,n,r,i){function o(){return l(KEY_PRIVATE_TOKEN)}function c(){return l(KEY_REFRESH_TOKEN)}function u(){return l(KEY_ACCESS_TOKEN)}function a(e){f(e,KEY_PRIVATE_TOKEN)}function s(e){f(e,KEY_REFRESH_TOKEN),_(null)}function _(e){null!==e&&(e.expires_at=Date.now()+1e3*e.expires_in),f(e,KEY_ACCESS_TOKEN)}function l(t){var n=e.localStorage.getItem(t);return!n||"{"!=n.charAt(0)&&"["!=n.charAt(0)?n:JSON.parse(n)}function f(t,n){if(t){var r=typeof t;"string"!==r&&"number"!==r&&(t=JSON.stringify(t)),e.localStorage.setItem(n,t)}else e.localStorage.removeItem(n)}function E(){return null!==o()||null!==c()}function h(e){return n(function(t,n){var i=o();if(i)return e.headers=e.headers||{},e.headers.Authorization="OAuth "+i,void t(e);if(r.disabled)return void t(e);var u=c();return u?void d(u).then(function(n){e.headers=e.headers||{},e.headers.Authorization="Bearer "+n.access_token,t(e)},function(){n()}):void n()})}function d(e){return n(function(t,n){var r=u();T(r)?t(r):(v.push(function(e){e?t(e):n()}),k||(k=!0,A(e).then(function(e){var t=e.data;_(t),k=!1,v.forEach(function(e){e(u())}),v=[]},function(){_(null),k=!1,v.forEach(function(e){e(null)}),v=[]})))})}function T(e){return e&&e.expires_at>Date.now()}function A(e){return t.post(makeUrl([i,PATH_TOKEN]),{client_id:r.clientId,client_secret:r.clientSecret,grant_type:"refresh_token",scope:r.scope||"basic",refresh_token:e})}function K(){var e={client_secret:r.clientSecret,client_id:r.clientId,redirect_uri:r.redirectUri,grant_type:"authorization_code",response_type:"code",state:"emAuth",scope:r.scope||"basic"};return makeUrl([i,PATH_AUTHORIZE],e)}function p(e){return t.post(makeUrl([i,PATH_TOKEN]),{grant_type:"authorization_code",code:e,client_id:r.clientId,client_secret:r.clientSecret,state:"emAuth",scope:r.scope||"basic",redirect_uri:r.redirectUri}).then(function(e){var t=e.data;s(t.refresh_token),_(t)})}var v=[],k=!1;return{getPrivateToken:o,setPrivateToken:a,getRefreshToken:c,setRefreshToken:s,isAuthenticated:E,authorizeUrl:K,handleAuthCode:p,authorize:h}};
