...
module.exports=function(e,t){var c=e({"default":"/complaint_cases",get:!0,query:!0,post:!0});return c.close=function(e){return t.request({url:"/complaint_cases/"+e+"/close",method:"PUT"})},c.checkup=function(e){return t.request({url:"/complaint_cases/"+e+"/checkup",method:"GET"})},c};


},{}],13:[function(require,module,exports){
module.exports=function(e){return e({forFeed:{"default":"complaint_handlers",get:!0,put:!0,post:!0,query:!0,"delete":!0}})};
...
var PATH_ASSIGN="/meters/many/assign_to",PATH_SHARE="/meters/many/share_with",PATH_REVOKE="/meters/many/revoke";module.exports=function(e,t){function r(e){return function(r,a){for(var n=[],u=r.length,s=a.length,o=0;u>o;o++)for(var l=r[o],h=0;s>h;h++){var i=a[h];n.push({_id:l,holder:i})}return t.request({url:e,method:"POST",data:n})}}function a(e){return t.request({url:PATH_REVOKE,method:"PUT",data:e})}var n=e({"default":"/meters",get:!0,query:!0,put:!0,post:!0,"delete":!0,batch:!0});return n.assign=r(PATH_ASSIGN),n.share=r(PATH_SHARE),n.revoke=a,n.recalculateStats=function(e){var r=[this._config["default"],e,"stats_recalc"].join("/");return t.request({method:"PUT",url:r})},n};
...
module.exports=function(t,r){var e=t({"default":"/readings",post:!0,put:!0});return e.get=function(t,e,n,u){u=u||["energy"],u=angular.isArray(u)?u:[u],n=angular.isArray(n)?n:[n];var i=[this._config["default"],t,e,n.join("+")].filter(function(t){return null!==t&&void 0!==t}).join("/");return r.request({method:"GET",url:i,params:{metrics:u.join(",")}})},e.interpolate=function(t,e){return r.request({method:"POST",url:[this._config["default"],t,"interpolate"].join("/"),data:e})},e.batch=function(t,e){var n=this._config["default"];return void 0!==e&&(n+="/"+e),r.request({method:"POST",url:n,data:t})},e};
...
var makeUrl=require("./util/makeurl"),ACCOUNTS_PATH="/accounts";module.exports=function(t){function e(t){function e(){this._config=t}t.get&&(e.prototype.get=n),t.query&&(e.prototype.query=a),(t.put||t.post)&&(e.prototype.save=o),t.batch&&(e.prototype.batchUpdate=u),t["delete"]&&(e.prototype["delete"]=i);for(var r in t)if(t.hasOwnProperty(r)&&0===r.indexOf("for")){var c=r.slice(3).toLowerCase()+"s";e.prototype[r]=f(c,t[r])}return new e}function r(t,e){var r=t[e];return r===!0?t["default"]:r}function n(e,n){var o={method:"GET",url:makeUrl([r(this._config,"get"),e])};return"object"==typeof n&&angular.extend(o,n),t.request(o)}function o(e,n){var o,u,a=e;void 0===e._id&&this._config.post?(o="POST",u=r(this._config,"post")):(o="PUT",u=r(this._config,"put")+"/"+e._id,a=angular.copy(e),delete a._id);var i={method:o,url:u,data:a};return"object"==typeof n&&angular.extend(i,n),t.request(i)}function u(e,n,o){for(var u=[],a=0,i=e.length;i>a;a++){var f=angular.copy(n);f._id=e[a],u.push(f)}var c={method:"PUT",url:r(this._config,"batch"),data:u};return"object"==typeof o&&angular.extend(c,o),t.request(c)}function a(e,n){var o={method:"GET",url:r(this._config,"query"),params:c(e)};return n&&angular.extend(o,n),t.request(o)}function i(e,n){var o={method:"DELETE",url:makeUrl([r(this._config,"delete"),e])};return"object"==typeof n&&angular.extend(o,n),t.request(o)}function f(t,r){return function(n){var o=angular.copy(r);return["default","get","put","post","delete","query"].forEach(function(e){var r=o[e];"string"==typeof r&&"/"!==r[0]&&(o[e]="/"+t+"/"+n+"/"+r)}),e(o)}}function c(t){var e={};for(var r in t)if(t.hasOwnProperty(r)){var n=t[r],o=angular.isString(n);null!==n&&void 0!==n&&(o&&n.length>0||!o)&&(e[r]=n)}return e}return e};
