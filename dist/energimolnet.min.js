...
var makeUrl=require("./util/makeurl"),PATH_TOKEN="oauth/token",PATH_AUTHORIZE="oauth/authorize",PATH_SIGN_IN="security/signin",PATH_SIGN_OUT="security/signout",KEY_PRIVATE_TOKEN="emPrivateToken",KEY_REFRESH_TOKEN="emRefreshToken",KEY_ACCESS_TOKEN="emAccessToken";module.exports=function(e,t,n,r,i){function o(){return l(KEY_PRIVATE_TOKEN)}function c(){return l(KEY_REFRESH_TOKEN)}function u(){return l(KEY_ACCESS_TOKEN)}function a(e){f(e,KEY_PRIVATE_TOKEN)}function s(e){f(e,KEY_REFRESH_TOKEN),_(null)}function _(e){null!==e&&(e.expires_at=Date.now()+1e3*e.expires_in),f(e,KEY_ACCESS_TOKEN)}function l(t){var n=e.localStorage.getItem(t);return!n||"{"!=n.charAt(0)&&"["!=n.charAt(0)?n:JSON.parse(n)}function f(t,n){if(t){var r=typeof t;"string"!==r&&"number"!==r&&(t=JSON.stringify(t)),e.localStorage.setItem(n,t)}else e.localStorage.removeItem(n)}function E(){return null!==o()||null!==c()}function d(e){return n(function(t,n){var i=o();if(i)return e.headers=e.headers||{},e.headers.Authorization="OAuth "+i,void t(e);if(r.disabled)return void t(e);var u=c();return u?void h(u).then(function(n){e.headers=e.headers||{},e.headers.Authorization="Bearer "+n.access_token,t(e)},function(){n()}):void n()})}function h(e){return n(function(t,n){var r=u();T(r)?t(r):(N.push(function(e){e?t(e):n()}),k||(k=!0,A(e).then(function(e){var t=e.data;_(t),k=!1,N.forEach(function(e){e(u())}),N=[]},function(){_(null),k=!1,N.forEach(function(e){e(null)}),N=[]})))})}function T(e){return e&&e.expires_at>Date.now()}function A(e){return t.post(makeUrl([i,PATH_TOKEN]),{client_id:r.clientId,client_secret:r.clientSecret,grant_type:"refresh_token",scope:r.scope||"basic",refresh_token:e})}function p(){var e={client_secret:r.clientSecret,client_id:r.clientId,redirect_uri:r.redirectUri,grant_type:"authorization_code",response_type:"code",state:"emAuth",scope:r.scope||"basic"};return makeUrl([i,PATH_AUTHORIZE],e)}function K(e){return t.post(makeUrl([i,PATH_TOKEN]),{grant_type:"authorization_code",code:e,client_id:r.clientId,client_secret:r.clientSecret,state:"emAuth",scope:r.scope||"basic",redirect_uri:r.redirectUri}).then(function(e){var t=e.data;s(t.refresh_token),_(t)})}function S(e){return makeUrl([i,PATH_SIGN_IN])+"?redirect="+encodeURIComponent(e)}function m(e){return makeUrl([i,PATH_SIGN_OUT])+"?redirect="+encodeURIComponent(e)}var N=[],k=!1;return{getPrivateToken:o,setPrivateToken:a,getRefreshToken:c,setRefreshToken:s,isAuthenticated:E,loginUrl:S,logoutUrl:m,authorizeUrl:p,handleAuthCode:K,authorize:d}};
...
module.exports=function(o,s,e,n,t,i,c,l,r,u,a,p,b,R,S,d,f,C,M,m,g,J,h,F,k,w,A,E,O,T,v){function x(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}x.Accounts=s,x.Apps=e,x.Clients=n,x.Complaints=t,x.CalculatedMetrics=i,x.ConsumptionStats=c,x.Consumptions=l,x.EdielJobs=r,x.Feeds=u,x.FileJobs=a,x.FtpConnections=p,x.Invitations=b,x.Me=R,x.Meters=S,x.MeterStats=d,x.MetricModels=f,x.Owners=C,x.Password=M,x.RefreshTokens=m,x.Reports=g,x.RobotJobs=J,x.RobotStats=h,x.Robots=F,x.Scrapers=k,x.Subaccounts=w,x.Subscribers=A,x.Tokens=E,x.DateUtil=O,x.api=T,x.auth=v,o.em=x};
...
module.exports=function(e){return e({"default":"/file_jobs",get:!0,query:!0,put:!0,save:!0,"delete":!0})};
