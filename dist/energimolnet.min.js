...
module.exports=function(o,s,n,e,t,i,c,l,r,u,a,p,b,R,S,d,f,C,M,g,m,J,h,k,F,T,w,A,E,O,v,x){function y(s,n){s.then(function(s){n===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}y.Accounts=s,y.Apps=n,y.Clients=e,y.Complaints=t,y.CalculatedMetrics=i,y.ConsumptionStats=c,y.Consumptions=l,y.EdielJobs=r,y.Feeds=u,y.FileJobs=a,y.FtpConnections=p,y.Invitations=b,y.LoginTokens=R,y.Me=S,y.Meters=d,y.MeterStats=f,y.MetricModels=C,y.Owners=M,y.Password=g,y.RefreshTokens=m,y.Reports=J,y.RobotJobs=h,y.RobotStats=k,y.Robots=F,y.Scrapers=T,y.Subaccounts=w,y.Subscribers=A,y.Tokens=E,y.DateUtil=O,y.api=v,y.auth=x,o.em=y};
