...
module.exports=function(o,s,e,n,t,i,r,c,l,a,u,p,b,R,S,d,f,g,C,M,m,J,T,h,k,F,w,A,E,O,v,x,y,D){function I(s,e){s.then(function(s){e===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}I.Accounts=s,I.Apps=e,I.Clients=n,I.Complaints=t,I.CalculatedMetrics=i,I.ConsumptionStats=r,I.Consumptions=c,I.EdielJobs=l,I.Feeds=a,I.FileJobs=u,I.FtpConnections=p,I.Invitations=b,I.LoginTokens=R,I.Me=S,I.Meters=d,I.MeterStats=f,I.MetricModels=g,I.Owners=C,I.Password=M,I.Readings=m,I.RefreshTokens=J,I.Reports=T,I.RobotJobs=h,I.RobotStats=k,I.Robots=F,I.Scrapers=w,I.ScraperTests=A,I.Subaccounts=E,I.Subscribers=O,I.Tokens=v,I.DateUtil=x,I.api=y,I.auth=D,o.em=I};
...
module.exports=function(r,e){var n=r({"default":"/readings"});return n.get=function(r,n,a,t){return t=t||["energy"],t=angular.isArray(t)?t:[t],a=angular.isArray(a)?a:[a],e.request({method:"GET",url:[this._config["default"],r,n,a.join("+")].join("/"),params:{metrics:t.join(",")}})},n};
