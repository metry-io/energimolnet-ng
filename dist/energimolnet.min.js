...
module.exports=function(o,s,n,e,t,i,c,l,r,a,u,p,b,R,d,S,f,g,C,M,m,J,h,k,F,T,w,A,E,O,v,x,y){function D(s,n){s.then(function(s){n===!0?o.console.log("Response:\n",s):o.console.log("Response:\n",JSON.stringify(s,null,2))},function(s){o.console.log("Error:\n",s)})}D.Accounts=s,D.Apps=n,D.Clients=e,D.Complaints=t,D.CalculatedMetrics=i,D.ConsumptionStats=c,D.Consumptions=l,D.EdielJobs=r,D.Feeds=a,D.FileJobs=u,D.FtpConnections=p,D.Invitations=b,D.LoginTokens=R,D.Me=d,D.Meters=S,D.MeterStats=f,D.MetricModels=g,D.Owners=C,D.Password=M,D.Readings=m,D.RefreshTokens=J,D.Reports=h,D.RobotJobs=k,D.RobotStats=F,D.Robots=T,D.Scrapers=w,D.Subaccounts=A,D.Subscribers=E,D.Tokens=O,D.DateUtil=v,D.api=x,D.auth=y,o.em=D};
