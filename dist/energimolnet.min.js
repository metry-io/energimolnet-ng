...
module.exports=function(s,o,n,e,t,i,r,a,l,c,p,u,C,b,R,S,d,m,f,g,M,T,h,k,F,J,w,A,O,v,x,y,D,E,H){function I(o,n){o.then(function(o){n===!0?s.console.log("Response:\n",o):s.console.log("Response:\n",JSON.stringify(o,null,2))},function(o){s.console.log("Error:\n",o)})}I.Accounts=o,I.Apps=n,I.Clients=e,I.ComplaintCases=t,I.ComplainHandlers=i,I.Complaints=r,I.CalculatedMetrics=a,I.ConsumptionStats=l,I.Consumptions=c,I.Feeds=p,I.FileJobs=u,I.FtpConnections=C,I.Invitations=b,I.LoginTokens=R,I.Me=S,I.Meters=d,I.MeterStats=m,I.MetricModels=f,I.Owners=g,I.Password=M,I.Readings=T,I.RefreshTokens=h,I.Reports=k,I.RobotJobs=F,I.RobotStats=J,I.Robots=w,I.Scrapers=A,I.ScraperTests=O,I.Subaccounts=v,I.Subscribers=x,I.Tokens=y,I.DateUtil=D,I.api=E,I.auth=H,s.em=I};
