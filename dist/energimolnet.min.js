...
module.exports=function(r,t){var e=r({"default":"/readings",post:!0,put:!0});return e.get=function(r,e,n,i){i=i||["energy"],i=angular.isArray(i)?i:[i],n=angular.isArray(n)?n:[n];var u=[this._config["default"],r,e,n.join("+")].filter(function(r){return null!==r&&void 0!==r}).join("/");return t.request({method:"GET",url:u,params:{metrics:i.join(",")}})},e.interpolate=function(r,e){return t.request({method:"POST",url:[this._config["default"],r,"interpolate"].join("/"),data:e})},e};
